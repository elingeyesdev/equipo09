...
let AuthController = class AuthController {
    ...
    async login(dto, req) {
        ...
        return new dto_2.ApiSuccessResponse(result, 'Login exitoso');
    }
    async me(req) {
        const user = req.user;
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Verificar token y obtener usuario autenticado' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Token válido. Usuario retornado.' }),
